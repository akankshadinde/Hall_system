<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ShowBooking.aspx.cs" Inherits="hallsystem.UserPanel.ShowBooking" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class ="container-fluid pt-4">
        <asp:GridView ID="GridViewShowData" runat="server" ShowHeaderWhenEmpty="True" CssClass="table table-striped table-bordered table-condensed table-striped"  AutoGenerateColumns="False" DataKeyNames="tblbookingid" OnRowDeleting="GridViewShowData_RowDeleting" OnRowDataBound="GridViewShowData_RowDataBound">
            <Columns>
