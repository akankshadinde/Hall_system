<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/Admin.Master" AutoEventWireup="true" CodeBehind="AddDecorationDesign.aspx.cs" Inherits="hallsystem.AdminPanel.AddDecorationDesign" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 col-md-8 col-md-4 col-sm-8 col-sm-12">
                    ...
                    <asp:Label ID="lblimgname" runat="server" Text="ImageName"></asp:Label>
                    <asp:TextBox ID="txtImgname" runat="server" CssClass="form-control w-75" placeholder="Enter ImageName"></asp:TextBox>
                </div>
            ...
            <div class="row">
                <div class="col-lg-4  col-md-8 col-md-4 col-sm-8 col-sm-12 pt-3 ">
                    ...
                    <asp:DropDownList ID="DropDowntype" runat="server" CssClass="form-control w-75" OnLoad="DropDowntype_Load">
                    </asp:DropDownList>
    ...
    <div class="container-fluid pt-5 ">
        <asp:GridView ID="GridView1" runat="server" OnLoad="GridView1_Load" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-condensed" ShowHeaderWhenEmpty="True" OnRowDeleting="GridView1_RowDeleting1" DataKeyNames="tblDesignId" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
            <Columns>
                <asp:BoundField DataField="tblDesignId" HeaderText="ID" ControlStyle-Width="150" ItemStyle-Width="50" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center"
                    ControlStyle-Height="150" ItemStyle-Height="150" />
                <asp:BoundField DataField="tblDesignname" HeaderText="Name" ControlStyle-Width="150" ItemStyle-Width="50" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center"
                    ControlStyle-Height="150" ItemStyle-Height="150" />
                <asp:ImageField DataImageUrlField="tblDesignImage" HeaderText="Picture" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center"
                    ControlStyle-Width="150" ItemStyle-Width="50"
                    ControlStyle-Height="150" ItemStyle-Height="150" />
                <asp:BoundField DataField="tblDesignPrice" HeaderText="Price" ControlStyle-Width="150" ItemStyle-Width="50" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center"
                    ControlStyle-Height="150" ItemStyle-Height="150" />
                <asp:BoundField DataField="tblDesigntype" HeaderText="Type" ControlStyle-Width="150" ItemStyle-Width="50" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center"
                    ControlStyle-Height="150" ItemStyle-Height="150" />
